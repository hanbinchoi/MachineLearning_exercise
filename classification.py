...
# KNN
print('=============================== KNN ================================')
parameters = {'weights': ['uniform', 'distance'], 'n_neighbors': [5, 10, 15, 20, 25]}
...
parameters = {"n_estimators": range(50, 100, 25), "max_depth": [1, 2, 4], "learning_rate": [0.0001, 0.001, 0.01, 0.1],
              "subsample": [0.7, 0.9]}
...
voting = VotingClassifier(estimators=[('rfc', rf_best), ('knn', knn_best), ('svc', sv_best), ('gbc', gb_best)
    , ('xgb', xgb_best)], voting='hard', n_jobs=5)
